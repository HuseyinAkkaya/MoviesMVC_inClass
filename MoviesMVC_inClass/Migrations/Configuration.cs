...
namespace MoviesMVC_inClass.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MoviesMVC_inClass.Contexts.MoviesContext>
    {
        ...
        protected override void Seed(MoviesMVC_inClass.Contexts.MoviesContext context)
        {
